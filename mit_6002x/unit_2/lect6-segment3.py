...
pylab.axhline(0, color="black", linewidth=1)  # Horizontal axis
pylab.axvline(0, color="black", linewidth=1)  # Vertical axis
pylab.axhline(-500, color="black", linewidth=1)  # Horizontal axis
pylab.axvline(0, color="black", linewidth=1)  # Vertical axis
pylab.show()
